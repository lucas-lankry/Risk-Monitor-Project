...
def create_pnl_formula(row_num):
    ...
    return (
        ...
        # ========== LONG POSITION ==========
        f'IF(Q{row_num}="C",'
        f'MAX(G{row_num}-N{row_num},0)*O{row_num}*D{row_num},'
        f'MAX(N{row_num}-G{row_num},0)*O{row_num}*D{row_num}),'
        # ========== SHORT POSITION ==========
        f'IF(Q{row_num}="C",'
        f'-MAX(G{row_num}-N{row_num},0)*O{row_num}*ABS(D{row_num}),'
        f'-MAX(N{row_num}-G{row_num},0)*O{row_num}*ABS(D{row_num})))'
    )
...
print(result_df[['Ticker', 'Maturity', 'Position', 'Last Price', 'Delta', 'B76_Delta']].head(10))
